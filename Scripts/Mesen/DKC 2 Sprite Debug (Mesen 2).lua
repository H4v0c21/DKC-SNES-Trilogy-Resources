--DKC 2 Sprite Debug Script v0.05
--By: H4v0c21
...
function Sprite_Debug()
	...
	for object_index = 0,23,1 do
		...
		object_main_routine = ReadObjectVariableWord(object_routine_table,object_type)
		object_animation_id = ReadObjectVariableWord(object,0x36)
