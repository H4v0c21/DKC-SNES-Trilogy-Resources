...
function SpriteDebug()
	...
	emu.drawRectangle(0, 0+renderOffsetY, 256, 60, 0x40404040, true, 1)
	emu.drawString(10, 10+renderOffsetY, "T: " .. ReadWord(0x2A), 0xFFFFFF, 0xFF000000)
	emu.drawString(10, 20+renderOffsetY, "P: " .. ReadWord(0x16D8+0x1A), 0xFFFFFF, 0xFF000000)
	emu.drawString(60, 20+renderOffsetY, ReadWord(0x16D8+0x1C), 0xFFFFFF, 0xFF000000)
	emu.drawString(10, 30+renderOffsetY, "R: " .. ReadWord(0x16D8+0x1E), 0xFFFFFF, 0xFF000000)
	emu.drawString(60, 30+renderOffsetY, ReadWord(0x16D8+0x20), 0xFFFFFF, 0xFF000000)
	
	emu.drawString(10, 50+renderOffsetY, ReadWord(0x16D8+0x1E) - ReadWord(0x16D8+0x1C), 0xFFFFFF, 0xFF000000)
end
